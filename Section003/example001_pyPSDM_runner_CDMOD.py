...
stalst_file = cwdfd+"/psdm/PSDM_qseis2022_CDMOD/SP.lat.lon.lst"
Mod_path = cwdfd+"/mod/"
PSDM_DataPath = cwdfd+"/psdm/PSDM_qseis2022_CDMOD/data/"
PSDM_pro_path = cwdfd+"/psdm/PSDM_qseis2022_CDMOD/"
subname = "QseisMig"
...
def moveout_joe(srfname):
    ...
    depth_begin = 1
    depth_end = 1200
    velocity_model = Mod_path+"CDmod.tvel"
    st = read(srfname)
    # st[0].plot()
    tr = st[0]
    trout = tr.copy()
...
os.getcwd()
sub_name = "QseisMig"
# build_taup_model(Mod_path+"CDmod.tvel")
model = TauPyModel(model=Mod_path+"CDmod.npz")
if (first_run):
...
plt.savefig(cwdfd+"/figs/"+"example001_CDmod_Station_Map.jpg",
...
plt.savefig(cwdfd+"/figs/"+"example001_CDmod_PSDM_Map.jpg",
            dpi=300, bbox_inches='tight')
